...
public class CompletableFutureBasics {
    ...
    public void map() throws ExecutionException, InterruptedException {
        ...
        final Optional<String> optFirstName = optPerson.map(p -> p.getFirstName());
        ...
        final CompletableFuture<String> futureFirstName = futurePerson.thenApply(p -> p.getFirstName());
    ...
    public void flatMap() throws ExecutionException, InterruptedException {
        ...
        final Optional<Integer> optFirstCodePointOfFirstName =
                optPerson.flatMap(p -> p.getFirstName().codePoints().mapToObj(v -> v).findFirst());
        ...
        final IntStream codePoints =
                streamPerson.flatMapToInt(p -> p.getFirstName().codePoints());
